...
- [ ] **T2 新增 `core/split-layout.ts` + 测试** | P0 | 1.5h | 无
...
- [ ] **T4 `tree-flatten` 加闭合行与 `hiddenPaths`** | P0 | 3h | 无
...
- [ ] **T11 新增 `core/json-table.ts` + 测试** | P0 | 3h | 无
...
- [ ] **T5 `SplitWorkspace` 容器 + CSS** | P0 | 3h | T2, T3
...
- [ ] **T8 `selectedPath` + 状态栏当前节点** | P1 | 1.5h | T6
...
- [ ] **T10 远程图片预览 + CSP + 设置开关** | P1 | 2.5h | T9
...
- [ ] **T12 `TableView` 弹窗 + CSS** | P0 | 3h | T11, T8
...
- [ ] **T13 ActionBar 按钮改造** | P0 | 1h | T5, T12
